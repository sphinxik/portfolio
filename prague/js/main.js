...
// GSAP ANIMATION =================================================================================
// HEADER
var headerTimeline = gsap.timeline({ delay: 1, onComplete: headerMapDotsPulse });
headerTimeline.from('.header-title', { x: -100, opacity: 0, duration: 0.5, ease: 'none' });
headerTimeline.from('.header-txt', { x: -100, opacity: 0, duration: 0.5, ease: 'none' });
headerTimeline.from('.header-top', { y: -100, opacity: 0, duration: 0.5, ease: 'none' });
headerTimeline.from('.header-bottom', { y: 100, opacity: 0, duration: 0.5, ease: 'none' }, 1.0);
headerTimeline.from('.header-map__mark', { scale: 0, opacity: 0, duration: 0.5, stagger: 0.3, ease: 'none' });
...
function addGoogleMap() {
	setTimeout(function () {
		...
		map.html('<iframe src="https://www.google.com/maps/d/u/0/embed?mid=1ROv8xZa2KuXdzcUvP8y7UOJVhSbaSJ9c"></iframe>');
	}, 1000);
}
